...
import type { StoryArgs } from "../../__test__/helpers.js";
...
export const BasicButton = renderComponent(storyTemplate).bind({});

export const Disabled = renderComponent(storyTemplate).bind({});
Disabled.args = {
  disabled: true
}